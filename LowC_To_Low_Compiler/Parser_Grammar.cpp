...
const std::vector<Grammar_Checker> Dest_Inc_Dec_Grammars =
{
	Grammar_Checker(
		{
			Checker_Function(Is_Token, T_POINTER), Checker_Function(Parse_Special_Recursive_Check, Expression16_Grammars),
...
const std::vector<Grammar_Checker> ID_Assign_Grammars =
{
	Grammar_Checker(
		{
			Checker_Function(Is_ID, S_ID8), Checker_Function(Is_Token, T_EQUALS), Checker_Function(Parse_Special_Recursive_Check, Expression8_Grammars),
			Checker_Function(Is_Token, T_SEMI)
		},
		Node_Init
		{
	...
	Grammar_Checker(
		{
			Checker_Function(Is_ID, S_ID8), Checker_Function(Is_Token, T_EQUALS), Checker_Function(Parse_Special_Recursive_Check, Expression16_Grammars),
			Checker_Function(Is_Token, T_SEMI)
		},
		Node_Init
		{
	...
	Grammar_Checker(
		{
			Checker_Function(Is_ID, S_ID16), Checker_Function(Is_Token, T_EQUALS), Checker_Function(Parse_Special_Recursive_Check, Expression16_Grammars),
			Checker_Function(Is_Token, T_SEMI)
		},
		Node_Init
		{
	...
	Grammar_Checker(
		{
			Checker_Function(Is_ID, S_ID16), Checker_Function(Is_Token, T_EQUALS), Checker_Function(Parse_Special_Recursive_Check, Expression8_Grammars),
			Checker_Function(Is_Token, T_SEMI)
		},
		Node_Init
		{
	...
	Grammar_Checker(
		...
		Node_Init
		{
			...
			else
			{
				...
				{
					Tokens_Passed += Parse_Special_Recursive_Check(Tokens + Tokens_Passed, &Generated_Nodes, Expression8_Grammars, 0) + 1;
				}
				else
					Tokens_Passed += Parse_Special_Recursive_Check(Tokens + Tokens_Passed, &Generated_Nodes, Expression16_Grammars, 0) + 1;
...
void Parse_Function_Call_Parameters(const Token* Tokens, std::vector<Parse_Node>& Recursively_Generated_Nodes, Parse_Node* New_Node, size_t& Tokens_Passed, const Parse_Node& Parameter_Node)
{
	if (Parameter_Node["type"][0].Syntax_ID == S_BYTE)
		Tokens_Passed += Parse_Special_Recursive_Check(Tokens + Tokens_Passed, &Recursively_Generated_Nodes, Expression8_Grammars, 0);
	else
		Tokens_Passed += Parse_Special_Recursive_Check(Tokens + Tokens_Passed, &Recursively_Generated_Nodes, Expression16_Grammars, 0);
...
const std::vector<Grammar_Checker> Function_Call_Grammars =
{
	Grammar_Checker(
		...
		Node_Init
		{
			...
			printf("\t parsing function call to %s...", Tokens[0].Name.c_str());
...
const std::vector<Grammar_Checker> Primary_Expression8 =
{
	Grammar_Checker(
		{
...
const std::vector<Grammar_Checker> Postfix_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Primary_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Unary_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Postfix_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Cast_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Unary_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Additive_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Cast_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Shift_Expression8 =
{
	Grammar_Checker(
		{
...
const std::vector<Grammar_Checker> And_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Shift_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Xor_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, And_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Or_Expression8 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Xor_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Expression8_Grammars =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Or_Expression8)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Primary_Expression16 =
{
	Grammar_Checker(
		{
			Checker_Function(Is_ID, S_ID16)
...
const std::vector<Grammar_Checker> Postfix_Expression16 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Primary_Expression16)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Unary_Expression16 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Postfix_Expression16)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Cast_Expression16 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Unary_Expression16)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Additive_Expression16 =
{
	Grammar_Checker(
		{
...
const std::vector<Grammar_Checker> Shift_Expression16 =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Additive_Expression16),
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
...
const std::vector<Grammar_Checker> Expression16_Grammars =
{
	Grammar_Checker(
		{
			Checker_Function(Parse_Special_Recursive_Check, Shift_Expression16)
		},
		Node_Init
		{
			Node_Set(Recursively_Generated_Nodes[0]);
