...
void call(pointer Function_Pointer);	// This needs a direct LOW implementation
...
typedef unsigned short pointer; // Note that pointers on SM83 architectures are also 16 bits
